...
<?php if($is_front): ?>
  <div id="slideshow-wrapper">
    ...
    <?php endif; ?>
    <div class="slideshow">
      <img src="<?php print $base_path . $directory; ?>/images/slideshows/plasticas.jpg" width="950" height="355" alt="Plasticas Castella"/>
      <img src="<?php print $base_path . $directory; ?>/images/slideshows/musica.jpg" width="950" height="355" alt="Musica Castella"/>
      <img src="<?php print $base_path . $directory; ?>/images/slideshows/teatro.jpg" width="950" height="355" alt="Teatro Castella"/>
      <img src="<?php print $base_path . $directory; ?>/images/slideshows/danza.jpg" width="950" height="355" alt="Danza Castella"/>
    </div>
  </div>
</div>
<?php endif; ?>
...
<div style="clear:both"></div>
<div id="notice">Desarrollado por <a href="http://www.negociosticos.com">NegociosTicos.com</a></div>
</div>
