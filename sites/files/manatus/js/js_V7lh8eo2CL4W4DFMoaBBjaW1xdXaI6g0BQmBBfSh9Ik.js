...
(function( $ ){
  $(document).ready(function() {
    ...
    function updateConfig() {
      ...
      $('#checkin-checkout').daterangepicker(options, function(start, end, label) { console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')'); });
    }
